...
void module_def_profiles(py::module_ &m)
{
    py::class_<RampProfile, PyProfile, std::shared_ptr<RampProfile>>(m, "RampProfile")
        ...
        .def_property_readonly("current_acceleration", &RampProfile::current_acceleration)
        .def_property_readonly("target_acceleration", &RampProfile::target_acceleration)
        .def("set_target_acceleration", &RampProfile::set_target_acceleration)
        .def_property_readonly("current_steps", &RampProfile::current_steps)
        .def("set_current_steps", &RampProfile::set_current_steps)
        .def("set_target_steps", &RampProfile::set_target_steps)
        .def_property_readonly("microsteps", &RampProfile::microsteps)
        .def("set_microsteps", &RampProfile::set_microsteps)
        .def_property_readonly("full_steps_per_rev", &RampProfile::full_steps_per_rev)
        .def("set_full_steps_per_rev", &RampProfile::set_full_steps_per_rev)
        .def("set_target_rpm", &RampProfile::set_target_rpm)
        .def_property_readonly("steps_to_go", &RampProfile::steps_to_go)
        .def_property_readonly("is_moving", &RampProfile::is_moving)
        .def_property_readonly("direction", &RampProfile::direction)
        .def_property_readonly("step_interval_us", &RampProfile::step_interval_us)
